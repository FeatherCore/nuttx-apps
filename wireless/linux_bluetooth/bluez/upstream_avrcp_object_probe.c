/****************************************************************************
 * apps/wireless/linux_bluetooth/bluez/upstream_avrcp_object_probe.c
 *
...
#define avrcp_set_volume bluez_upstream_object_avrcp_set_volume
#define avrcp_register_player bluez_upstream_avrcp_object_register_player
#define avrcp_unregister_player bluez_upstream_avrcp_object_unregister_player
#define avrcp_player_event bluez_upstream_avrcp_object_player_event
...
#define avrcp_get_target_player_by_device bluez_upstream_object_avrcp_get_target_player_by_device
#define avrcp_player_init bluez_upstream_avrcp_object_player_init
#define avrcp_player_exit bluez_upstream_avrcp_object_player_exit
...
#include "upstream/profiles/audio/avrcp.c"
...
void bluez_upstream_avrcp_object_probe_print(const char *role)
{
  printf("bluez-upstream-object: audio/avrcp.c role=%s linked=1 "
         "source=third/bluez/profiles/audio/avrcp.c "
         "profile=AVRCP owner=bluetoothd\n",
         role);
}

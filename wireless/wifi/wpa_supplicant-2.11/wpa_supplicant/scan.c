...
#ifdef __NuttX__
	/*
	 * The NuttX hwsim lower-half currently implements normal trigger scans,
	 * but not nl80211 scheduled scan offload. Keep supplicant startup and P2P
	 * smoke tests on the normal scan path until sched_scan_start/stop exist.
	 */
	return -1;
#endif /* __NuttX__ */

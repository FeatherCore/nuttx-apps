...
static unsigned int nuttx_nl80211_if_nametoindex(const char *ifname)
{
	int ifindex;

	ifindex = ieee80211_linux_if_nametoindex(ifname);
	if (ifindex > 0)
				   ...
				   const char *driver_params)
{
	...
	drv->ifindex = nuttx_nl80211_if_nametoindex(bss->ifname);
				      ...
				      struct wpa_driver_set_key_params *params)
{
	...
	ifindex = nuttx_nl80211_if_nametoindex(ifname);
				     ...
				     void *arg)
{
	...
	ifidx = nuttx_nl80211_if_nametoindex(ifname);
